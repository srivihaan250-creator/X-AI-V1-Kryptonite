...
3. **Launch**: Run the python file where you pasted the the pyton code I gave you(to run, click the top green play button in the top center beside the debug button)
4. **Note for 8GB RAM**: Close Chrome or other heavy apps before generating to ensure the VRAM Purge works perfectly on your PC.
...
Quick is fast, completes generation in 12 steps but is a little bit low on quality.
